...
int main()
{
    ...
    array_buf[4].sem_num = SEM_CONNECT;
    array_buf[4].sem_op  = 1;
    array_buf[4].sem_flg = SEM_UNDO;
    semOperator (sem_common_id, array_buf, 5);
